...
public final class CMOS implements HardwareComponent,
    ...
    public void shutdown() {
        ...
        try {
            ...
            File parentDir = m_nvRamFile.getParentFile();
            ...
            // Silently ignore - NVRAM persistence is optional for headless operation
            System.out.println("[CMOS] Could not save NVRAM (non-fatal): " + ex.getMessage());
        }
    }
